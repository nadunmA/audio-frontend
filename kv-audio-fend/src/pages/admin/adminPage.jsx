...
import AdminIteamPage from "./adminIteamsPage";
import AddIteamPage from "./addItemPage";
    ...
    return (
        ...
        <div className='w-full h-screen flex'>
              ...
              <Routes path="/*">
                ...
                <Route path="/items" element={<AdminIteamPage/>}/>
                <Route path="/items/add" element={<AddIteamPage/>}/>
              </Routes>
